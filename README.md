...
- **ADB** Copyright © The Android Open Source Project. Licensed under the [Apache License, Version 2.0 (the "License").](LICENSE-APACHE2.txt)
- **scrcpy** Copyright © Genymobile. Licensed under the [Apache License, Version 2.0 (the "License").](LICENSE-APACHE2.txt)
- **Bundletool** Copyright © Google LLC. Licensed under the [Apache License, Version 2.0 (the "License").](LICENSE-APACHE2.txt)
