...
>
  <defs>
    <mask id={maskId}>
      <!-- Fondo blanco: mantener visible -->
      <rect width="100" height="100" fill="white" />
      
      <!-- Ojos negros: recortar (transparentes) -->
      <svg x="5" y="5" width="90" height="90" viewBox="1849.15 0 673.11 400">
        <path d="m 2360.79,298.98697 c 13.47,-8.966 15.43,-29.71 4.37,-46.331 -11.05,-16.622 -30.93,-22.827 -44.39,-13.861 -13.47,8.967 -15.43,29.71 -4.37,46.331 11.05,16.622 30.93,22.828 44.39,13.861 z" fill="black" />
        <path d="m 2055.6,285.18397 c 11.06,-16.622 9.1,-37.365 -4.37,-46.331 -13.47,-8.967 -33.34,-2.761 -44.4,13.86 -11.05,16.622 -9.09,37.365 4.37,46.331 13.47,8.967 33.35,2.761 44.4,-13.86 z" fill="black" />
      </svg>
      
      <!-- Silueta de la llave negra engrosada -->
      <svg x="60" y="56" width="38" height="38" viewBox="0 0 24 24">
        <g transform="translate(12,12) rotate(100) translate(-12,-12)">
          <path 
            d="M19.6 15.9l-6-6c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l6 6c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z" 
            fill="black"
            stroke="black"
            stroke-width="1.5"
  ...
  <!-- Llave principal (sin sombra porque la máscara ya cortó el hueco) -->
  <svg x="60" y="56" width="38" height="38" viewBox="0 0 24 24" data-tauri-drag-region>
    <g transform="translate(12,12) rotate(100) translate(-12,-12)">
      <path 
        d="M19.6 15.9l-6-6c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l6 6c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z" 
        fill={wrenchColor} 
