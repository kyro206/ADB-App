export const es: Record<string, string> = {
  ...
  'control.input.advanced': 'Entrada avanzada ADB / Macros',
  'control.input.advancedDesc': 'Un comando por línea. Se puede usar "sleep ms" para pausas.',
  'control.input.run': 'Ejecutar',
  'control.macro.import': 'Importar',
  'control.macro.export': 'Exportar',
  'control.macro.saved': 'Macro guardada con éxito',
